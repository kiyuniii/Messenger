/****************************************************************************
** Meta object code from reading C++ file 'widget_contact.h'
**
...
#include "../../header/view/widget_contact.h"
...
#error "The header file 'widget_contact.h' doesn't include <QObject>."
...
void Profile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showProfileInfo(); break;
        default: ;
        }
    }
    (void)_a;
