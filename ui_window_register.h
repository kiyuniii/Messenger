...
public:
    ...
    void setupUi(QMainWindow *RegisterWindow)
    {
        ...
        button_isIDTaken = new QPushButton(centralwidget);
        button_isIDTaken->setObjectName("button_register");
        button_isIDTaken->setGeometry(QRect(480, 260, 100, 50));
...
""));
    ...
    void retranslateUi(QMainWindow *RegisterWindow)
    {
        ...
        button_isIDTaken->setText(QCoreApplication::translate("RegisterWindow", "\354\244\221\353\263\265\355\231\225\354\235\270", nullptr));
