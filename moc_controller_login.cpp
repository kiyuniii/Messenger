/****************************************************************************
** Meta object code from reading C++ file 'controller_login.h'
**
...
#include "header/controller/controller_login.h"
...
#error "The header file 'controller_login.h' doesn't include <QObject>."
...
void LoginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginManager::emit_logout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
